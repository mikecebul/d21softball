  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    ...
    variants: {
      size: {
        clear: '',
        fit: 'h-10 px-4 py-2',
        default: 'h-10 px-4 py-2 w-full md:w-auto min-w-64',
        icon: 'size-10',
        lg: 'h-11 px-8',
        sm: 'h-9 px-3',
        xl: 'h-12 px-8',
      ...
      variant: {
        ...
        footerNav:
          'text-base font-medium transition-colors hover:bg-accent/50 hover:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 rounded-lg justify-start',
